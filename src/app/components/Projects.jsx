...
const Projects = () => {
  ...
  return (  
    <section id="work" className="lg:h-screen h-full text-slate-300 flex justify-center items-center flex-col gap-5">
      ...
      <div className={`flex flex-col lg:flex-row gap-5 ex:w-full w-80 md:w-1/2 lg:min-h-44 p-3 rounded-md hover:bg-slate-800/50 hover:shadow-md border-slate-600 hover:border-t ${screenMobile ? 'bg-slate-800/50 shadow-md border-slate-600 border-t' : ''}`}>
        ...
        <div>
          <h2 className={`${ibmPlexMono.className} text-lg pb-2`}>Prestamista</h2>
      ...
      <div className={`flex flex-col lg:flex-row gap-5 ex:w-full w-80 md:w-1/2 lg:min-h-44 p-3 rounded-md hover:bg-slate-800/50 hover:shadow-md border-slate-600 hover:border-t ${screenMobile ? 'bg-slate-800/50 shadow-md border-slate-600 border-t' : ''}`}>
        ...
        <div>
          <h2 className={`${ibmPlexMono.className} lg:flex text-lg pb-2`}>Learnflow</h2>
          <p className="text-sm w-full">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum
            inventore voluptas, enim atque odio incidunt at similique recusandae
            dolor vel eveniet nisi ratione dignissimos nam, sed, officia
